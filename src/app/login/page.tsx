                ...
                <section className="bg-gray-50 min-h-screen flex items-center justify-center">
                    ...
                    <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
                        ...
                        <div className="md:w-1/1 px-16">
                            ...
                            <form action="" className="flex flex-col gap-4">
                                ...
                                <div className="flex flex-row-reverse justify-between">
                                    <label htmlFor="showPassword" className="mb-2">
                                        <input
                                            type="checkbox"
                                            id="persist"
                                            name="persist"
                                            ...
                                            className='mr-1'
                                        /> Remember Me</label>
                                    <Link href={"/forgot"} className="text-sm text-blue-600 hover:text-blue-700 pb-2">Forgot Password?</Link>
                                </div>
                        ...
                        <div className="md:block hidden w-1/2 p-5">
                            <Image src="https://picsum.photos/600/900" alt="img" width={600} height={900} style={{ borderRadius: "15px" }} />
                        </div>
                    </div>
                    {/* </div> */}
                </section >
